...
<head>
    ...
    <title>Administrador BOTELLITA S&W </title>

    <!-- ================= Favicon ================== -->
    <!-- Standard -->
    <link rel="shortcut icon" href="../extras/logos/favicon.png" type="image/x-icon">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form action="../../controller/registrarUsersAdmin.php" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="number" name="numeroID" class="form-control" placeholder="Ej:102356987">
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label>Nombres</label>
                                                    <input type="text" name="nombres" class="form-control" placeholder="Luisa Fernanada">
                                                </div>

                                                <div class="form-group col-md-4">
                                                    <label>Apellidos</label>
                                                    <input type="text" name="apellidos" class="form-control" placeholder="Vega Zambrano">
                                                </div>

                                                <div class="form-group col-md-4">
                                                    <label>Telefono</label>
                                                    <input type="number" name="telefono" class="form-control" placeholder="3154896325">
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label>Foto </label>
                                                    <input type="file" accept=".jpg, .png, .jpeg, .gif" name="foto" class="form-control" placeholder="seleccione archivo" >
                                                </div>


                                            </div>
                                            
                                            <button type="submit" class="btn btn-default primary">Registrar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
