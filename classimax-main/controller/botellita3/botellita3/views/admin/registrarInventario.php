                                        ...
                                        <form action="" method="POST">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Ej:102356987">
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label>Nombres</label>
                                                    <input type="text" class="form-control" placeholder="Luisa Fernanada">
                                                </div>

                                                <div class="form-group col-md-4">
                                                    <label>Apellidos</label>
                                                    <input type="text" class="form-control" placeholder="Vega Zambrano">
                                                </div>

                                                <div class="form-group col-md-4">
                                                    <label>Telefono</label>
                                                    <input type="number" class="form-control" placeholder="3154896325">
                                                </div>
