                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../controller/registrarServicio.php" method="POST" enctype="multipart/form-data">
                                
                                <div class="row formulario">
                                    <div class="form-group col-md-6">
                                        <label>Nombre</label>
                                        <input type="text" class="form-control" placeholder="Computador, celular" name="nombre_ser">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Precio</label>
                                        <input type="text" class="form-control" placeholder="200000" name="precio_ser">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Duración</label>
                                        <input type="text" class="form-control" placeholder="1, 2, 3" name="duracion">
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30">Crear nuevo servicio</button>
