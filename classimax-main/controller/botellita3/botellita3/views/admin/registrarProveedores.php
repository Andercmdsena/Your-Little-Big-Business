                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form action="../../controller/registrarProvAdmin.php" method="POST" enctype="multipart/form-data">
                                            <div class="row">

                                                <div class="form-group col-md-4">
                                                    <label>Nit empresa</label>
                                                    <input type="number" name="nit_empre" class="form-control" placeholder="">
                                                </div>


                                                <div class="form-group col-md-4">
                                                    <label>Nombre de empresa</label>
                                                    <input type="text" name="nom_empre" class="form-control" placeholder="">
                                                </div>

                                                <div class="form-group col-md-4">
                                                    <label>Nombre proveedor</label>
                                                    <input type="text" name="nom_prov" class="form-control" placeholder="">
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="number" name="tel_prov" class="form-control" placeholder="3154896325">
                                                </div>

                                                <div class="form-group col-md-4">
                                                    <label>Logo empresa </label>
                                                    <input type="file" accept=".jpg, .png, .jpeg, .gif" name="logo_empre" class="form-control" placeholder="seleccione archivo" >
                                                </div>
