<?php
   ...
   // definir el peso limite y los formatos
    ...
    if($_FILES['logo_empreA']['error']>0){
        ...
        $logo_empre ="../upload/usuarios/".$_FILES ['logo_empreA']['name'];

        $resultado = move_uploaded_file($_FILES['logo_empreA']['tmp_name'],$logo_empre);
    ...
    $result = $objetoConsultas->actulizarFotoProvAdmin( $nit_empre,$logo_empre);
